...
//    catch (const char* em)
//    {
//        std::cout << "exeption and...." << em << std::endl;
//    }
//    try
//    {
//        Triangle objTri(10, 20, 30, 50, 60, 70);
//        Shapes* shapes = &objTri;
//        shapes->printFigure();
//    }
//    catch (const char* em2)
//    {
//        std::cout << "exeption2 and...." << em2 << std::endl;
//    }
//}
...
public:
    ...
    Triangle(int a, int b, int c, int A, int B, int C) {
        if ((A + B + C) != 180) {
            throw "Треугольник не соответствует заданным параметрам!";
        }
        this->a = a;
        this->b = b;
        this->c = a;
...
public:
    ...
    RectangularTriangle(int a, int b, int c, int A, int B, int C) {
        if (C != 90 || (A + B + C) != 180) {
            throw "Прямоугольный треугольник не соответствует заданным параметрам!";
        }
        this->a = a;
        this->b = b;
        this->c = c;
...
public:
    ...
    IsoscelesTriangle(int a, int b, int c, int A, int B, int C) {
        if (a != c || A != C || (A + B + C) != 180) {
            throw "Равнобедреный треугольник не  соответствует заданным параметрам!";
        }
        this->a = a;
        this->b = b;
        this->c = a;
...
public:
    ...
    EquilateralTriangle(int a, int b, int c, int A, int B, int C) {
        if (a != b || b != c || A != 60 || B != 60 || C != 60 || (A + B + C) || 180) {
            throw "Равносторонний треугольник не соответствует заданным параметрам!";
        }
...
public:
    ...
    Quadrilateral(int a, int b, int c, int d, int A, int B, int C, int D) {
        if ((A + B + C + D) != 360) {
            throw "Четырехугольник не соответствует заданным параметрам!";
        }
        this->a = a;
        this->b = b;
        this->c = c;
...
public:
    ...
    Rectangle(int a, int b, int c, int d, int A, int B, int C, int D) {
        if (a != c || b != d || A == 90 || B != 90 || C != 90 || D != 90 || (A + B + C + D) != 360) {
            throw "Прямоугольник не соответствует заданным параметрам!";
        }
        this->a = a;
        this->b = b;
        this->c = c;
...
public:
    ...
    Square(int a, int b, int c, int d, int A, int B, int C, int D) {
        if (a != c || b != d || a != c || A != 90 || B != 90 || C != 90 || D != 90 || (A + B + C + D) != 360) {
            throw "Квадрат не соответствует заданным параметрам";
        }
        this->a = a;
        this->b = b;
        this->c = c;
...
public:
    ...
    Parallelogram(int a, int b, int c, int d, int A, int B, int C, int D) {
        if (a != c || b != d || A != C || B != D || (A + B + C + D) != 360) {
            throw "Параллелограмм не соответствует заданным параметрам";
        }
        this->a = a;
        this->b = b;
        this->c = c;
...
public:
    ...
    Rhomb(int a, int b, int c, int d, int A, int B, int C, int D) {
        if (A != C || B != D || (A + B + C + D) != 360) {
            throw "Ромб не соответствует заданным параметрам";
        }
        this->a = a;
        this->b = b;
        this->c = c;
...
int main()
{
    ...
    try
    {
        RectangularTriangle objRT2(10, 20, 30, 50, 400, 90);
        shapes = &objRT2;
        print_shapes(shapes);
    }
    catch (const char* em)
